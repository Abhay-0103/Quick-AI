  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        ...
        <form className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
            <div onSubmit={onSubmitHandler} className='flex items-center gap-3'>
            ...
            <p className='mt-4 text-sm font-medium'>Article Length</p>
                ...
                <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
                  ...
                  <br />
                  <button className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#226BFF] to-[#65ADEF] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
                    <Edit className='w-5' />
                    Generate Article
                  </button>
        </form>
        {/* Right col*/}
        <div className='w-full max-w-lf p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
                  ...
                  <div className='flex-1 flex justify-center items-center'>
                    <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                      ...
                      <p>Enter Your Topic and Click "Generate Article" To Get Started</p>
                    </div>
                  </div>
        </div>
    </div>
